<?php    
    ...
    $contenidos=[
        ...
        "categoriasDeBienes"=>['"Muebles"','"Equipos y Material de Laboratorio"','"Material Didáctico"','"Instrumentos Musicales"','"Equipos de Cómputo"',
                                '"Equipos de Comunicación"','"Equipos Audiovisuales"','"Equipos de Bombeo"','"Equipos de Oficina"',
                                '"Maquinaria de Talleres y Diversos Oficios"','"Maquinaria Agrí­cola"','"Bibliobancos de Textos Escolares"',
                                '"Material Bibliográfico"','"Licencias de Software"','"Semovientes"','"Muebles y Equipos de Enfermerí­a y Primeros Auxilios"',
                                '"Extintores de Incendio"','"Bienes de Consumo (Papelerí­a y Aseo)"','"Libros Reglamentarios"','"Enseres"','"Primeros Auxilios"',
                                '"Implementos de Aseo"','"Implementos de Recreación y Deportes"','"Utensilios de Cocina"','"Edificaciones"',
                                '"Herramientas y Materiales"','"Reporte de Necesidad"','"Reporte para Mantenimiento"'],
